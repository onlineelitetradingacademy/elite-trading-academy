...
const lessonSchema = new mongoose.Schema({
  ...
  description:  String,
  type:         { type: String, enum: ['video', 'notes', 'quiz', 'qa', 'live'], default: 'video' },
  videoUrl:     String,
...
const courseSchema = new mongoose.Schema({
  title:          { type: String, required: [true, 'Course title required'], trim: true },
  ...
  category:       { type: String, enum: ['forex', 'stocks', 'crypto', 'commodity', 'options', 'technical_analysis', 'fundamental_analysis', 'risk_management', 'psychology', 'combo'], required: true },
  courseType:     { type: String, enum: ['recorded', 'live_online', 'live_offline', 'mentorship', 'free'], default: 'recorded' },
