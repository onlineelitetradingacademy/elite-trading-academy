...
const webinarSchema = new mongoose.Schema(
  {
    ...
    platform: {
      type: String,
      enum: ['zoom', 'google_meet', 'youtube_live', 'jitsi'],
      default: 'zoom',
    },
...
const paymentSchema = new mongoose.Schema(
  {
    ...
    itemType: {
      type: String,
      enum: ['Course', 'Batch', 'Webinar', 'Mentorship'],
    },
    itemTitle: String,
...
const resourceSchema = new mongoose.Schema(
  {
    type: {
      type: String,
      enum: ['broker', 'book', 'merchandise', 'tool', 'indicator', 'bot'],
      required: true,
    },
    title: { type: String, required: true },
    description: String,
...
const gallerySchema = new mongoose.Schema(
  {
    type: {
      type: String,
      enum: ['photo', 'video', 'award', 'telegram', 'podcast', 'event'],
      required: true,
    },
    title: String,
    url: String,
