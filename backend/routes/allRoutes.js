...
courseRouter.get(
  '/admin/all',
  protect,
  authorize('admin', 'sub_admin', 'mentor'),
  courseCtrl.adminGetCourses,
);
...
franchiseRouter.get(
  ...
  protect,
  authorize('admin', 'sub_admin'),
  ctrl.getFranchiseLeads,
);
franchiseRouter.put(
  '/:id',
  protect,
  authorize('admin', 'sub_admin'),
  ctrl.updateFranchiseLead,
);
...
settingRouter.get(
  ...
  protect,
  adminOnly,
  settingCtrl.getAllAnnouncements,
);
settingRouter.post(
  '/announcements',
  protect,
  adminOnly,
  settingCtrl.createAnnouncement,
);
settingRouter.put(
  '/announcements/:id',
  protect,
  adminOnly,
  settingCtrl.updateAnnouncement,
);
settingRouter.delete(
  '/announcements/:id',
  protect,
  adminOnly,
  settingCtrl.deleteAnnouncement,
);
module.exports.settingRoutes = settingRouter;

// ── SUPPORT ROUTES ────────────────────────────────────────────────
const supportRouter = express.Router();
supportRouter.post('/', protect, ctrl.createTicket);
...
notifRouter.get('/', protect, (req, res) =>
