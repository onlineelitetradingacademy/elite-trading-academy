...
export default function App() {
  ...
  return (
    <HelmetProvider>
      <BrowserRouter>
        <Toaster position="top-right" toastOptions={{ style: { background: '#1A1A28', color: '#E8E8F0', border: '1px solid rgba(240,165,0,0.2)' }, success: { iconTheme: { primary: '#F0A500', secondary: '#0A0A0F' } } }} />
        <SocialProofPopup />
        <FloatingContact />
        ...
        <Suspense fallback={<Loader />}>
          <Routes>
            ...
            <Route element={<MainLayout />}>
              ...
              <Route path="/privacy-policy"      element={<Privacy type="privacy" />} />
              <Route path="/terms-of-service"    element={<Terms type="terms" />} />
            ...
            <Route element={<AuthLayout />}>
              ...
              <Route path="/auth/forgot-password"element={<GuestRoute><ForgotPass /></GuestRoute>} />
              <Route path="/auth/reset-password/:token" element={<GuestRoute><ResetPass /></GuestRoute>} />
