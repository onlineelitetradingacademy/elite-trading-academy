...
export default function Login() {
  ...
  const handleGoogleLogin = () => {
    window.location.href = `https://api.elitetradingacademy.in/api/auth/google`; //replaced on claude suggestion
  };

  return (
    <>
      <Helmet>
        <title>Login — ELITE Trading Academy</title>
      </Helmet>
          ...
          <div className="relative z-10 flex flex-col justify-center px-16">
            ...
            >
              ...
              <p className="text-muted text-lg mb-8">
                Join 5,000+ traders who have already transformed their financial
                future.
              </p>
              <div className="space-y-4">
                {[
                  'Expert-led courses in Forex, Stocks & Crypto',
                  'Live trading sessions with real-time guidance',
                  'Personal mentorship programme available',
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-muted">
                Login to your ELITE Trading Academy account
              </p>
            </div>
